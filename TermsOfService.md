**Terms of Service: MyArt**

**Effective Date: 20.01.2026**

**1. Acceptance of Terms**

    By adding and using MyArt, you agree to be bound to the Terms of Service. If you do not agree, do not use the bot.
...
**2.2. Content Safety**
    ...
    By using the bot to upload content, you acknowledge that you are required to appropriately inform other users of the nature of your content through the bot's tag functionality.
...
**5. Spending Access and Content Removal**

    We reserve the right to terminate or suspend your access to the bot and to remove the content you've uploaded at our sole discretion, without prior notice or liability, for any reason, including if you breach the Terms.

**6. Disclaimers**

    The bot is provided on an "AS IS" and "AS AVAILABLE" basis. The owner is not responsible for any kind of data loss caused by glitches or bugs from Discord's API and other Discord services.
...
**8. Changes to Terms**
    ...
    We reserve the right to modify these Terms at any time. We will notify you of any changes by posting the new Terms in the github repository. Your continued use of the bot after such changes constitutes your acceptance of the new Terms.